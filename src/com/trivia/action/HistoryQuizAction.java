...
public class HistoryQuizAction extends ActionSupport implements SessionAware {

	private static final long serialVersionUID = 6951392193848718624L;
	public Quiz q;
	...
	public String execute() {
		...
		int userscore = 0;
		ResultSet rs = db.getHistoryQuestions();
		try {
		...
		if (user_answer != null) {
			...
			if (userQuestion == 5) {
				addActionMessage(
						"You have completed the quiz on the History Category. Complete the rest of the quizzes to get a final score. "
